import { $l as PreviewCardContextValue, Au as ReleasesUpsellContextValue, Bf as MentionUserContextValue, Bt as DocumentFieldActionNode$1, Dv as SearchContextValue, Ft as DocumentFieldAction$1, Gg as CommentsContextValue, Hf as TasksEnabledContextValue, Iu as MetadataWrapper, Iy as RouterHistory, Lf as TasksUpsellContextValue, Oh as EventsStore, Rc as ReferenceInputOptions, Rf as TasksContextValue, Rn as PortableTextMemberItem, Ry as CommentsSelectedPathContextValue, Sr as FormValueContextValue, T_ as StudioAnnouncementsContextValue, Ty as WorkspacesContextValue, UC as PerspectiveContextValue, Uc as FormCallbacksValue, Ug as CommentsEnabledContextValue, Uu as DivergenceNavigator, Vb as Locale, Vg as CommentsOnboardingContextValue, W_ as CopyPasteContextType, XS as TrackerContextGetSnapshot, Xg as CommentInputContextValue, Xp as DocumentChangeContextInstance, Yy as CommentIntentGetter, ZS as TrackerContextStore, _y as AddonDatasetContextValue, aC as ConnectorContextValue, dr as FormBuilderContextValue, fs as FieldCommentsProps, g_ as UpsellDialogViewedInfo, hb as CommentsAuthoringPathContextValue, hg as TagValue, is as PortableTextMarker, lp as DocumentActionDescription, ml as ZIndexContextValue, mp as DocumentActionProps, n_ as UpsellData, ni as FieldPresenceData, or as VirtualizerScrollInstance, pt as Source$1, py as StudioColorScheme, qS as ChangeIndicatorTrackerContextValue, ri as FormNodePresence, sc as EnhancedObjectDialogContextValue, t as ActiveWorkspaceMatcherContextValue, t_ as CommentsUpsellContextValue, tg as UserColorManager, vi as ResourceCache, vp as SchedulesContextValue, vt as Workspace, xg as ConsentStatus, y_ as NavbarContextValue, zf as TasksNavigationContextValue } from "./_chunks-dts/ActiveWorkspaceMatcherContext.js";
 ...
 * @internal
 */
declare const ColorSchemeSetValueContext: _$react.Context<false | ((nextScheme: StudioColorScheme) => void) | null>;
/**
