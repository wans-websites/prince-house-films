 ...
 * @beta
 */
declare const DocumentListPane: _$react.NamedExoticComponent<BaseStructureToolPaneProps<"documentList">>;
/**
 * @deprecated Import from `sanity/structure` instead!
 * @hidden
 * @beta
 */
declare const DocumentPane: _$react.NamedExoticComponent<DocumentPaneProviderProps$1>;
/**
 * @deprecated Import from `sanity/structure` instead!
 * @hidden
 * @beta
