import * as _portabletext_schema8 from "@portabletext/schema";
...
declare class PortableTextEditor {
  ...
  static findByPath: (editor: PortableTextEditor, path: Path) => [_portabletext_schema8.PortableTextSpan | PortableTextObject | _portabletext_schema8.PortableTextTextBlock<_portabletext_schema8.PortableTextSpan | PortableTextObject> | undefined, Path | undefined];
  /**
   * @deprecated
   * Use `editor.send(...)` instead
   *
